...
`check_copy.py` catches the mechanical ones; the rest are judgment.

- Em dashes (—) or spaced en dashes as punctuation. Use a full stop, colon, comma or brackets.
- AI tells: seamless(ly), elevate, enhance your, effortless(ly), game-changer, supercharge,
  unleash, unlock, dive in, delve, look no further, whether you're, it's not just, take your ... to
  the next level, say goodbye to, tailored, robust, streamline, empower, level up your, in today's.
- Hype adjectives: powerful, ultimate, amazing, stunning, sleek, cutting-edge, revolutionary.
- Rhetorical questions ("Tired of...?"), exclamation marks in store copy, emoji bullets, bolded
  words mid-sentence for emphasis, "Key Features" style Title Case headings.
- Tricolon rhythm everywhere ("fast, simple and beautiful"), and every paragraph the same length.
- Closing summaries ("In short, ...", "Overall, ...").
